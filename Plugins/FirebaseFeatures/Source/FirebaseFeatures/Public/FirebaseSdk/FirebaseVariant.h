...
public:
    ...
    UFUNCTION(BlueprintCallable, BlueprintPure, Category = "Firebase|Misc|Variant", meta = (CompactNodeTitle = "JSON", BlueprintAutocast))
    static FString ToJson(UPARAM(ref) const FFirebaseVariant& Value);
